 ...
 */
export declare enum SelectModeOptions {
    Single = "single",
    Multi = "multi"
}
...
export declare type ISortDirection = 'asc' | 'desc' | null;
export declare type ColumnValuePrepareFunction = (cellValue: any, rowData: any, cell: Cell) => any;
export declare type ColumnFilterFunction = (cellValue: any, searchString: string, allData: any, cellName: string, rowData: any) => boolean;
